	...
	if(isset($_POST['login_btn'])) {
		...
		if($result > 0) {
			...
			if($data['tipe'] == "admin") {
				...
				header("Location:logged-in-admin/index.php");

			} else if ($data['tipe'] == "user") {
				$_SESSION['user'] = $data['username'];
				$_SESSION['tipe'] = "user";

				header("Location:logged-in-user/index.php");
			} else {
	...
	<div id="main-container">
		<div id="login-form">
			...
			<form id="form" method="POST" action="">
				...
				<input type="password" name="login_password" placeholder="Passoword" required>
				<span>
